...
caps_lock_regex = re.compile(r'caps lock:\s+(on|off)', re.IGNORECASE)


class CapsLock(InLoopPollText):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_defaults(CapsLock.defaults)
    ...
    def poll(self):
        ...
        return 'CAPSLOCK' if 'on' in sub_string else ''
